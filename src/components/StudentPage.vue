  ...
  <div class="wrapper">
    <div class="students">
        <div class="students-1">
            <div class="students-1-pic">
              🧔🏻‍♂️
            </div>
            <div class="students-1-name">
              Damon Salvatore
            </div>
            <div class="students-1-personal">
              Phone: 999-999-9856 <br/>
              Address: 123 Main St, McAllen, TX 78505
            </div>
            <div class="students-1-educational">
        ...
        <div class="students-2">
            ...
            <div class="students-2-name">
              Elena Gilbert
            </div>
            <div class="students-2-personal">
              Phone: 985-685-7598 <br/>
              Address: 4307 11th St, San Antonio, TX 78210
            </div>
            <div class="students-2-educational">
        ...
        <div class="students-3">
            ...
            <div class="students-3-name">
              Caroline Forbes
            </div>
            <div class="students-3-personal">
              Phone: 754-215-4875 <br/>
              Address: 234 Glenda Rd, Donna, TX 78537
            </div>
            <div class="students-3-educational">
        ...
        <div class="students-4">
            ...
            <div class="students-4-name">
              Bonnie Bennet
            </div>
            <div class="students-4-personal">
              Phone: 546-857-9586 <br/>
              Address: 5438 Spider Dr, Brownsville, TX 78523
            </div>
            <div class="students-4-educational">
...
.wrapper {
  ...
  .students-1 {
        ...
        &-name{
          @apply text-4xl py-2 italic font-bold;
        }
        &-personal{
          @apply font-medium text-sm;
        }
        &-educational{
          @apply font-semibold py-2 text-lg;
        }
    }
.students-2 {
        @apply rounded-md bg-blue-200 p-2 text-slate-900 text-center;
        &-pic{
          @apply text-6xl p-3;
        }
        &-name{
